package hoandmph27404.fpoly.hoandmph27404_thi.Adapter;
...
import hoandmph27404.fpoly.hoandmph27404_thi.webviewwww;
        ...
        if (newss!=null){
            ...
            tvTitle.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(context, webviewwww.class);
