package hoandmph27404.fpoly.myapplicationtest.adapter;
...
import hoandmph27404.fpoly.myapplicationtest.R;

public class ProductCategoryAdapter extends RecyclerView.Adapter<ProductCategoryAdapter.ProductViewHolder> {

    Context context;
    List<hoandmph27404.fpoly.myapplicationtest.adapter.ProductCategory> productCategoryList;

    public ProductCategoryAdapter(Context context, List<hoandmph27404.fpoly.myapplicationtest.adapter.ProductCategory> productCategoryList) {
