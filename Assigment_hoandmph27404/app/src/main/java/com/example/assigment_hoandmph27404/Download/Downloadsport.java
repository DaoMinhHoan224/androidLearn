...
public class Downloadsport extends AsyncTask<String, Void, List<Trangchu>> {

    SportFragment fragment=null;
    RecyclerView recyclerViewsp;
    AdapterNews adapterNews;

    public Downloadsport(SportFragment fragment){
    ...
    protected void onPostExecute(List<Trangchu> trangchus) {
        ...
        recyclerViewsp = fragment.getActivity().findViewById(R.id.recyclerviewSport);
        ...
        recyclerViewsp.setAdapter(adapterNews);
    }
}
