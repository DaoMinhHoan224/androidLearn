...
public class Downloadweather extends AsyncTask<String, Void, List<Trangchu>> {

    WeatherFragment fragment=null;
    RecyclerView recyclerViewweather;
    AdapterNews adapterNews;

    public Downloadweather(WeatherFragment fragment){
    ...
    protected void onPostExecute(List<Trangchu> trangchus) {
        ...
        recyclerViewweather = fragment.getActivity().findViewById(R.id.recyclerviewwt);
        ...
        recyclerViewweather.setAdapter(adapterNews);
    }
}
